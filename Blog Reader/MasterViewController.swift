...
//  Blog Reader
//
//  Created by Sahariar Kabir on 6/10/17.
...
//		get url from web
		...
		let url = URL(string:"https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyCfqDPaUd1xL2fwSbMK95Ba266FN55euQA")!
			...
			if error != nil {
				...
				if let dataContent = data {
					...
					do{
						...
						let json = try JSONSerialization.jsonObject(with: dataContent, options: []) as? [String:Any]
...
//						print(json!)
						...
						let request = NSFetchRequest<Event>(entityName: "Event")
							...
							for item in items {
								print("Publish Date:\(item["published"]!)")
